# first, run the server as: python3 umbridge-server-simplex-param_beta-h-c-phi-gamma.py
# run this script as:       python3 test_umbridge-server-simplex-param_beta-h-c-phi-gamma.py http://localhost:4242  
