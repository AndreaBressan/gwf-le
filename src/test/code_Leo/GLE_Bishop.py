...
##----------------------------------------------------------------------------#
def GLE(Ns , xa , ya , Ra , sds_in , sds_out , gamma , c , phi_rad):
    """
    GLE : General Limit Equilibrium
    dovrebbe fare tutti i metodi insieme
    ma qui metto solo Bishop
    ...
    #     z = slices['y_middle_top'][i]
    #     if z > 2.5:
    #         z1 = min(slices['sliceheight'][i] , z - 2.5)
    #         z2 = max(0 , slices['sliceheight'][i] - z1)
    #     else:
    #         z1 = 0
    #         z2 = slices['sliceheight'][i]
            
    #     sigma = 18.63*z1 + 17.64*z2
    #     sv.append(sigma)
    # # # print(sv)
    # slices['sv (kPa)'] = sv
    ...
    # slices['W'] = slices['slicebase'] * slices['sv (kPa)']
