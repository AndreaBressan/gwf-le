...
FoS = [GLE(Ns , xa[i] , ya[i] , Ra[i] ,sds_in[i] ,sds_out[i] , 
...
# ##----------------------------------------------------------------------------#
print(f'The grid contains {len(grid):d} points')
print('F griglia:' , round(grid.index[0],5))
...
Salvo i dati
"""
grid.to_excel('griglia.xlsx', sheet_name='data', index=True)